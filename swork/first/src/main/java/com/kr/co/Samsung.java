...
public class Samsung implements TV {
	...
	@Override
	public void powerOn() { System.out.println("삼성 전원 켜기"); }
	public void powerOff() { System.out.println("삼성 전원 끄기"); }
	public void volumeUp() { System.out.println("삼성 볼륨 올리기"); }
	public void volumeDown() {System.out.println("삼성 볼륨 낮추기"); }
