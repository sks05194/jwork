...
<body>
	<ul>
		...
		<li>
			현재 페이지의 URI(요청 URI) = <%=request.getRequestURI()%><br>
			현재 페이지의 URL(요청 URL) = <%=request.getRequestURL()%><br>
			<small style="color: red">URL에서 현재 페이지의 경로를 구함. String으로 반환</small>
		</li>
		<li>
