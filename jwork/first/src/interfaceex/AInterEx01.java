...
public class AInterEx01 {
	...
	public static void main(String[] args) {
		// 인터페이스 타입의 객체는 인터페이스에서 선언된 상수와 메소드(오버라이드 포함)에만 접근 가능
		A ob = new A1();
		ob.display("테스트1");
...
//		ob.pmd();
		// 인터페이스의 static 메소드는 객체명으로 접근 불가, 오버라이드 불가
//		System.out.println(ob.stmd(5));
		...
		System.out.println("A의 a 값 출력" + ob2.a);
...
class A1 implements A {
	...
	void pmd() {
		System.out.println("A1 인터페이스 안의 pmd: " + CONS);
	}
}